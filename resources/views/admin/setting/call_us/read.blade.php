...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ url('/admin/call_us/read') }}"><i class="fa fa-permissions"></i>اتصل بنا المقرؤه</a></li>
        </ol>
    </section>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        @permission('call-us-change-status')
                                        <td align="center">
                                            <a href="{{ url('/admin/call_us/change_status/'.$data->id)}}"><i class="btn btn-sm btn-primary ace-icon fa fa-edit bigger-120  edit" data-id=""> غير المقرؤه</i></a>
                                        </td>
                                            @endpermission
                                        <td align="center">
